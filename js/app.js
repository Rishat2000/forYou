(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".reviews__slider")) new swiper_core_Swiper(".reviews__slider", {
            ...
            navigation: {
                prevEl: ".reviews__block-prev button",
                nextEl: ".reviews__block-next button"
            },
            breakpoints: {
                300: {
                    slidesPerView: 1,
    ...
    da.init();
    function initializeHoverContentToggle() {
        const slides = document.querySelectorAll(".services__column");
        slides.forEach((slide => {
            slide.addEventListener("click", (function() {
                const hoverContents = document.querySelectorAll(".hover-content-services");
                hoverContents.forEach((content => {
                    if (content !== slide.querySelector(".hover-content-services")) content.classList.remove("show");
                }));
                const hoverContent = slide.querySelector(".hover-content-services");
                if (hoverContent) {
    ...
    function checkScreenWidth() {
        if (window.matchMedia("(max-width: 800px)").matches) initializeHoverContentToggle(); else {
            const slides = document.querySelectorAll(".services__column");
            slides.forEach((slide => {
    ...
    const script_checkbox = document.querySelector("#c_1");
    const submitButton = document.querySelector(".text-popup__submit");
    script_checkbox.addEventListener("change", (function() {
        submitButton.disabled = !script_checkbox.checked;
    }));
    window["FLS"] = true;
    menuInit();
    spollers();
